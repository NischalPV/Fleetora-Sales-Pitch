    ...
    return (
        <section className="h-screen w-full flex flex-col items-center justify-center px-8 relative overflow-hidden bg-slate-950">
            ...
            <div className="w-full max-w-3xl space-y-4">
                ...
                <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="bg-slate-800/50 border border-slate-700 rounded-2xl p-4">
                ...
                {/* Invoice table */}
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7 }} className="bg-slate-800/50 border border-slate-700 rounded-2xl overflow-hidden">
                    ...
                    {INVOICES.map((inv, i) => (
                        <motion.div key={i} initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.75 + i * 0.07 }} className="grid grid-cols-[1fr_120px_80px_70px_70px] px-4 py-2.5 border-t border-slate-700/30 items-center">
