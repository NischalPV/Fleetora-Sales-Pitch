        ...
        content: (
            <div className="h-full flex flex-col justify-center px-6 py-4">
                <div className="space-y-1.5">
                    {[{ l: "5 days × 35,000 JOD/day", a: "175,000" }, { l: "Full insurance", a: "25,000" }, { l: "Tax (7%)", a: "14,000" }, { l: "Speed camera ticket", a: "25,000" }].map((r, i) => (
