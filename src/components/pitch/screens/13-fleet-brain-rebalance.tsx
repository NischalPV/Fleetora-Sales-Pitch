    ...
    return (
        <section className="h-screen w-full flex flex-col items-center justify-center px-8 relative overflow-hidden bg-slate-950">
            ...
            <div className="w-full max-w-xl space-y-4">
                {/* Recommendation card */}
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3, type: "spring", stiffness: 60 }} className="bg-slate-800/50 border border-slate-700 rounded-2xl p-5" style={{ boxShadow: "0 12px 40px -10px rgba(0,0,0,0.4)" }}>
                    ...
                    <div className="flex gap-2">
                        ...
                        <motion.button initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.1 }} className="px-4 bg-slate-900 border border-slate-700 text-slate-300 text-sm font-medium py-2.5 rounded-xl hover:bg-slate-800 transition-colors">Override</motion.button>
                    </div>
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }} className="flex items-center justify-center gap-4">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.1 }} className="text-[9px] text-blue-400 font-semibold mt-1">2 SUVs →</motion.p>
                    </div>
